...
import platformImg from '@/assets/platform-wall.png';
  ...
  return (
    <div className="min-h-screen container mx-auto px-4 py-10 max-w-xl">
      ...
      <div className="relative flex justify-center mb-8">
        <div className={`relative transition-all duration-1000 ${isBreaking ? 'animate-wall-break' : ''} ${revealed ? 'opacity-30 scale-95' : ''}`}>
          <img
            src={platformImg}
            alt="Platform 9¾ Wall"
        ...
        {(isBreaking || revealed) && (
          <>
            ...
            <div className="absolute -top-2 right-1/3 w-12 h-12 bg-foreground/5 rounded-full blur-xl animate-float" style={{ animationDelay: '1s' }} />
          </>
        )}
      </div>
