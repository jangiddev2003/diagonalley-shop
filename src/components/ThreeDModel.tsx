...
import olivanderVideo from '@/assets/wand-bg-clip.mp4';
...
export const ThreeDViewer = ({ productName }: { productName?: string }) => {
  ...
  const isBroom = ["Nimbus 2000", "Nimbus 2001", "Firebolt", "Comet 260", "Cleansweep Eleven"].includes(productName || "");
  const isWand = !isBroom;
    ...
    >
      {isWand && (
        <video
          ...
          muted
          playsInline
          className="absolute inset-0 w-full h-[120%] object-cover object-top pointer-events-none"
        />
      )}
